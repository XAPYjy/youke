...
def search_view(request):
    ...
    if request.method == "GET":
        ...
        search_lessons = YkLesson.objects.filter(q1|q2).values_list('id','yk_lesson_name', 'yk_lesson_img','yk_lesson_price','yk_buy_amount','yk_lesson_price_type','yk_teacher_describe')
        if search_lessons:
